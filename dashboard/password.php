              ...
              <div class="row">
                ...
                <div class="row margin">
                  <div class="input-field col s12">
                    ...
                    <label for="email" class="center-align">Nueva contraseña</label>
                  </div>
                </div>
                <div class="row margin">
                  <div class="input-field col s12">
                    ...
                    <input id="password" type="password">
                    <label for="email" class="center-align">Repite la contraseña</label>
                  </div>
                </div>
                <div class="row">
                  <div class="input-field col s12">
                    <a href="login.php" class="btn waves-effect waves-light border-round black col s12 mb-1">Cambiar</a>
                  </div>
                </div>
              </form>
            </div>
