...
*/
    ...
    {
        self::connect(); // conectar con la base.
        self::$statement = self::$connection->prepare($query); // preparar la sentencia SQL.
        $state = self::$statement->execute($values);  // ejecutar sentencia SQL.
        self::$id = self::$connection->lastInsertId(); // obtiene el valor de la última llave primaria insertada.
        self::desconnect(); // desconectar la base.
        return $state; 
    }
